<template>
  <div>
    ...
    <!--字典弹窗-->
    <AppCateModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="govmap-appCate" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import AppCateModal from './components/AppCateModal.vue';
  import {columns,searchFormSchema} from './AppCate.data';
  ...
  async function handleDelete(record) {
    await deleteAppCate({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteAppCate({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
