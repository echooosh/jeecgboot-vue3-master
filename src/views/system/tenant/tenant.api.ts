...
// 部门名称映射
export const customsNameMap: Record<string, string> = {
  南京海关: 'NANJING CUSTOMS DISTRICT P.R.CHINA',
  青岛海关: 'QINGDAO CUSTOMS DISTRICT P.R.CHINA',
  上海海关: 'SHANGHAI CUSTOMS DISTRICT P.R.CHINA',
};
