          ...
          <div class="aui-form">
            <div class="aui-image">
              <div class="aui-image-text">
                <!--                <img :src="adTextImg" />-->
                <span class="login-left-text">海关政务地图</span>
              </div>
            </div>
...
<script lang="ts" setup name="login-mini">
  ...
  onMounted(async () => {
    ...
    if (redirect && redirect.includes('token=')) {
      // 添加一个基础url
      const redirectUrl = new URL(redirect, 'http://localhost:3100');
      const tempToken = redirectUrl.searchParams.get('token');
